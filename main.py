...
- **Total biaya persediaan = Rp {biaya_total_persediaan:,.2f}**, yang merupakan penjumlahan antara biaya pemesanan dan biaya penyimpanan.

**Kesimpulan:**  
Model EOQ membantu perusahaan dalam menentukan **jumlah pembelian optimal** sehingga biaya total persediaan (ordering + holding cost) berada pada titik minimum.
""")
